                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="borrowed-books.php"><i class="fa fa-heart"></i> <span>Donated Books</span></a></li>
                  ...
                  <div class="col-12 mt-5">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <label> Click the button below to load the books you donated. We really value your privacy.</label>
                              <br>

                              <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" onclick="donatedBook()">View Donated books.</button>
